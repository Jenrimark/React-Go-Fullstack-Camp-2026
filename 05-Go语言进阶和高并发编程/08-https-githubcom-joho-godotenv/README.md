...
说明：
- 该条目来自 GitHub 仓库 README，已转成本地 Markdown 并下载图片资源。

# GoDotEnv ![CI](./assets/01.svg) [![Go Report Card](./assets/02.png)](https://goreportcard.com/report/github.com/joho/godotenv)
